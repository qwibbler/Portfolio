...
(function() {
  ...
  addStyle = function(selector, rules) {
    // console.log('addStyle', selector, rules);
    var prop, style, val;
    style = "." + selector + "{";
    for (prop in rules) {
      val = rules[prop];
  ...
  createEl = function(className) {
    console.log('createEl', className);
    var el;
  ...
  cloneEl = function(parent, deep, className) {
    console.log('cloneEl', parent, deep, className);
    var el;
  ...
  OriDomi = (function() {
    function OriDomi(el1, options) {
      ...
      console.log('this._config', this, this._config);
